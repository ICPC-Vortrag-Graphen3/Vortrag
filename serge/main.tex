...
\begin{frame}{Einmaliger "greedy" Tausch}
    \begin{figure}
    ...
    \begin{figure}
        \begin{tikzpicture}[scale=0.7]
            ...
            \foreach \i/\amount in {{1/1}, {2/0}, {3/0}, {4/2}, {5/3}}
            {
                ...
                \draw [edge, visible on=<{1-}>] (BobS) -- (Type_\i) node [pos=0.7, above, sloped]
                (amount_\i) {$\amount$};
                \draw [edge, visible on=<{1-}>] (Type_\i) -- (BobT) node [pos=0.7,
                above, sloped] {$1$};
            }
    ...
    \begin{figure}
        \begin{tikzpicture}[scale=0.7]
            ...
            \foreach \source/\dest/\amount in {{Chef/1_{in}/3}, {Chef/2_{in}/4}, {1_{in}/1_{out}/2}, {2_{in}/2_{out}/2}, {1_{out}/Server/7}, {2_{out}/Server/2}}
                ...
                above, sloped] (\source\dest) {$\amount$};
            \draw[dashed, thick, visible on=<{4}>] plot [smooth] coordinates {(0,2) (2,0)
                (0,-2)};
            ...
            \draw[thick, red, dashed, visible on=<{5}>] plot [smooth]
                coordinates {(5,3) (4,-3)};
            \node[visible on=<{4-5}>] at (5,4) {$4$};
            \draw[thick, dashed, visible on=<{4}>] plot [smooth]
                coordinates {(4,3) (3.5,0.5) (2.5,-0.5) (2, -3)};
            \node[visible on=<{4}>] at (2,-4) {$5$};
            \draw[thick, dashed, visible on=<{4}>] plot [smooth] coordinates {(9,2) (7,0) (9,-2)};
            \node[visible on=<{4}>] at (9,3) {$8$};
            \draw[thick, red, dashed, visible on=<{5}>] plot [smooth]
