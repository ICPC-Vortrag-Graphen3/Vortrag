...
\begin{tikzpicture}[scale=1.3, auto,swap]
	...
	\path<2->[color=blue, dashed, ->, ultra thick] (a) edge[bend left] node [right] {} (b);
...
\begin{tikzpicture}[scale=1.3, auto,swap]
	...
	\path<2->[color=blue, dashed, ->, ultra thick] (a) edge[bend left] node [right] {} (b);
    \path<3->[color=blue, dashed, ->, ultra thick] (b) edge[bend right] node [left] {} (c);
    \path<4->[color=blue, dashed, ->, ultra thick] (c) edge[bend right] node [right] {} (e);
...
\begin{tikzpicture}[scale=1.0, auto,swap]
	...
	\path[color=blue, dashed, ->, ultra thick] (a) edge[bend left] node [right] {} (b);
    \path[color=blue, dashed, ->, ultra thick] (b) edge[bend right] node [left] {} (c);
    \path[color=blue, dashed, ->, ultra thick] (c) edge[bend right] node [right] {} (e);
    
	\begin{pgfonlayer}{background}
        \draw [black, rounded corners,thick, dashed] (-0.7,-1.7) rectangle (0.7,2.7);
        \draw [black, rounded corners,thick, dashed] (1.3,-1.7) rectangle (2.7,2.7);
        \foreach \source / \dest / \fr in {c/b/3, a/b/4, a/b/5, c/e/4, c/e/5}
